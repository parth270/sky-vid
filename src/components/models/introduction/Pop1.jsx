...
const Pop1 = () => {
  return (
    <>
      <Title title="Introduction" width={100} />
      <div className="w-[100%] overflow-y-auto scroll-hidden h-[92%]  px-[5%] ">
        <p className="font-medium fckin  text-[18px] text-[#000]">
          The term “metaverse” is regularly used as marketing shorthand for any
          virtual space or augmented reality in which users interact with
          ...
          direction of the metaverse—where it becomes an open and interoperable
          driver of an emerging business paradigm disrupted by
          decentralization—and the impact of customer control of their own data.{" "}
        </p>
        <ul className="list-outside list-disc mt-[10px]">
          <li className="text-[#000] fckin font-medium mb-[10px]">
            ...
            “return on learning” toward what HFS describes as value across three
            horizons:
            <div className="flex flex-col mt-[10px]">
              ...
              <span>
                ⎯Horizon 3: Horizon 2 + unearthing new sources of value to drive
                growth and manage risks at the ecosystem level
              </span>
            </div>
          </li>
          <li className="text-[#000] fckin font-medium mb-[10px]">
