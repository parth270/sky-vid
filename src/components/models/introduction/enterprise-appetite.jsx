  ...
  return (
    <>
      ...
      <div className="w-[100%] overflow-y-auto scroll-hidden h-[92%]  px-[5%] ">
        <div className="w-[100%] min-h-[100px] mt-[30px]">
        ...
        <div className="w-[90%] mx-[5%] min-h-[100px] py-[30px] bg-[#f2f2f2] mb-[30px] px-[5%] mt-[30px]">
          ...
          <p className="text-[18px] my-[20px] text-[#000] fckin tracking-wide font-medium">
            ...
            this (14%) as related to their metaverse ambitions suggests a
          ...
          <p className="text-[18px] my-[20px] text-[#000] fckin tracking-wide font-medium">
            ...
            as part of a program with a clearer view on the more holistic
            business outcomes that the shift to metaverse can deliver
          </p>
          <p className="text-[18px] text-[#000] fckin tracking-wide font-medium">
